      ...
      <div class="container">
        <div class="header-inner">
          ...
          <div class="header-actions">
            ...
            <button class="btn btn-primary">{{ $t('header.freeTrial') }}</button>
          </div>
        </div>
      </div>
    </header>
