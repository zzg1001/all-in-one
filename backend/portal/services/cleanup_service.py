...
from app.core.config import get_settings, get_uploads_dir, get_outputs_dir, get_skills_storage_dir, get_file_manage_dir
...
async def cleanup_deleted_data_notes(db: Session) -> Tuple[int, int]:
    ...
    for note in notes_to_delete:
        ...
        # 删除向量索引
        try:
            from portal.routers.data_notes import get_vector_service
...
async def cleanup_deleted_skills(db: Session) -> Tuple[int, int]:
    ...
    """
    from portal.services.storage.utils import delete_skill_folder_from_storage
